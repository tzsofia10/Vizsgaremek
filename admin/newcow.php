...
<body>
    ...
    <div id="success-message" class="success">
        ...
        <div class="success__close" onclick="document.getElementById('success-message').style.display='none'">
            <svg height="20" viewBox="0 0 20 20" width="20" xmlns="http://www.w3.org/2000/svg"><path d="m15.8333 5.34166-1.175-1.175-4.6583 4.65834-4.65833-4.65834-1.175 1.175 4.65833 4.65834-4.65833 4.6583 1.175 1.175 4.65833-4.6583 4.6583 4.6583 1.175-1.175-4.6583-4.6583z" fill="#2B641E"></path></svg>
        </div>
    </div>
    <?php endif; ?>
